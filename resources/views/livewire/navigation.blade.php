    ...
    <div class="flex justify-between h-16">
      <div class="flex flex-wrap">
        ...
        @canany(array_map(fn($item) => $item->permission, $this->vehicleNavs))
          <div class="hidden sm:-my-px sm:mr-2 sm:flex">
            <x-nav-link-dropdown :active="request()->routeIs(['vehicle','vehicle.show','vehicle.create','vehicle.edit','vmodel','vtype', 'brand'])"  width="48"
        ...
        @canany(array_map(fn($item) => $item->permission, $this->financialNavs))
          <div class="hidden sm:-my-px sm:mr-2 sm:flex">
            <x-nav-link-dropdown :active="request()->routeIs(['sale.create', 'sale.show', 'sales', 'sale.installments', 'installments', 'vehicle-expense'])"  width="48"
              contentClasses="py-1 bg-white dark:bg-gray-700">
              <x-slot name="trigger">
                <button
                  class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
