...
{{--
    <div class="hidden md:flex md:items-center md:w-auto w-full order-3 md:order-1" id="menu">
      <nav>
        <ul class="md:flex items-center justify-between text-base text-gray-700 pt-4 md:pt-0">
          <li><a class="inline-block no-underline hover:text-black hover:underline py-2 px-4" href="#">{{ __('About') }}
            </a></li>
        </ul>
      </nav>
    </div> --}}
    ...
    <div class="order-2 md:order-3 flex items-center" id="nav-content">
      @persist('theme')
      <button class="pr-2 flex items-center tracking-wide no-underline hover:no-underline font-bold"
      ...
      @endpersist
      <a class="inline-block no-underline hover:text-black" href="{{ route('login') }}" wire:navigate>
