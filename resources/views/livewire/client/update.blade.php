<div>
  ...
  <div class="space-y-2 mb-4">
    ...
    <x-form.input name="affiliated_three" label="Affiliated (3)" placeholder="Affiliated (3)"
      :messages="$errors->get('form.affiliated_three')" wire:model="form.affiliated_three" class="w-full" />
    <div class="flex flex-col md:flex-row justify-between md:space-x-2">
      <div class="basis-1/2">
    ...
    <div class="flex flex-col md:flex-row justify-between md:space-x-2">
      ...
      <div class="md:basis-1/3">
        <x-form.input name="city" label="City" placeholder="City" :messages="$errors->get('form.city')"
          wire:model="form.city" class="w-full" />
      </div>
    </div>
