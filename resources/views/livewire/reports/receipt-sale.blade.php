<div class="indent-2 container m-3 space-y-3 text-justify">
    ...
    <div class="space-y-3">
      <p>Eu, {{ $sale->user->employee->name }}, CPF: {{ $sale->user->employee->cpf }}, declaro que recebi do(a)
        {{ $sale->client->name }}, CPF: {{ $sale->client->cpf }}, o valor <x-span-money class="font-bold" :money="$sale->total" />
